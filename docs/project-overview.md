...
The system does not introduce additional first-class actor roles such as reviewer. Review is captured through comments, summary, and verification evidence rather than a dedicated workflow role.
