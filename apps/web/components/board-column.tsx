...
export function BoardColumn({
  ...
  return (
    <section className="flex min-w-[300px] flex-1 flex-col gap-4 rounded-xl border border-border bg-surface p-4 shadow-sm">
      ...
      <div className="flex flex-1 flex-col gap-3">
        {cards.length === 0 ? (
          <div className="rounded-lg border border-dashed border-border bg-surface/50 px-4 py-8 text-sm text-muted-foreground">
